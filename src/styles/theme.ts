/**
 * Tema centralizado para a aplicação
 * Contém constantes de estilo para garantir consistência visual
 */
...
export const theme = {
  ...
  // Valores z-index para controlar camadas
  zIndex: {
    dropdown: 10,
    sticky: 20,
    fixed: 30,
...
// Exportar tipos para melhor suporte de TypeScript
