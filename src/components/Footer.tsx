  ...
  return (
    <footer className="bg-white border-t border-gray-200 mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">
              Sua loja online com os melhores produtos e ofertas imperdíveis.
            </p>
            <div className="flex gap-4">
              {/* Ícones de redes sociais com melhor acessibilidade */}
              {[
          ...
          {/* Links de rodapé organizados em colunas */}
          {[
            {
              title: "Institucional",
              links: [
            ...
            },
            {
              title: "Ajuda",
              links: [
                { name: "Central de atendimento", href: "#" },
            ...
            <div key={index}>
              ...
              {column.isContact ? (
                <ul className="space-y-2 text-sm text-gray-600">
                  {column.contacts?.map((contact, idx) => (
        ...
        {/* Rodapé com copyright e métodos de pagamento */}
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600 mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} ShopSmart. Todos os direitos reservados.
          </p>
          <div className="flex gap-4">
            {/* Métodos de pagamento */}
            {[...Array(4)].map((_, index) => (
              <div key={index} className="w-10 h-6 bg-gray-200 rounded" aria-label="Método de pagamento"></div>
            ))}
          </div>
        </div>
      </div>
